    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="surname" class="block w-full mt-1" type="text" name="surname" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <select name="class" id="class" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" required>
            ...
            <div class="mt-4">
                <x-label for="school" value="{{ __('Scuola') }}" />
                <livewire:school-selector />
            </div>

            <div class="mt-4">
                <x-label for="section" value="{{ __('Sezione') }}" />
                <select name="section" id="section" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" required>
            ...
            <div class="mt-4">
                <x-label for="role_id" value="{{ __('Ruolo') }}" />
                <select name = "role_id" class = 'block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600'> 
